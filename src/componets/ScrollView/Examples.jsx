...
function Images() {
  ...
  useFrame(() => {
    ...
    group.current.children[2].material.zoom = 1 + data.range(0 / 3, 1 / 3) / 3
    group.current.children[3].material.zoom = 1 + data.range(0 / 3, 1 / 3) / 2
    group.current.children[4].material.zoom = 1 + data.range(0 / 3, 1 / 3) / 1
  ...
  return (
    <group ref={group}>
      ...
      {/* <Image position={[0, -height * 2 - height / 4, 0]} scale={[width, height / 2, 1]} url="/img4.jpg" /> */}
    </group>
  )
}
      ...
      <Suspense fallback={null}>
        <ScrollControls damping={4} pages={3}>
          ...
          <Scroll html>
            ...
            {/* <h1 style={{ position: 'absolute', top: '230vh', left: '0.5vw', fontSize: '40vw' }}>Welcome,Home</h1> */}
          </Scroll>
        </ScrollControls>
        <Preload />
      </Suspense>
